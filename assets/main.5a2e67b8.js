import{P as e,c as o,_ as i}from"./App.vue_vue_type_script_setup_true_lang.4b91e294.js";const t=""+new URL("horseshoe-crab.834901ca.jpg",import.meta.url).href,a=""+new URL("logo-big.572e3684.png",import.meta.url).href;e.content.notification={title:"SUBCOMS WANTED!",content:`We are currently looking for subcoms for the 2022-2023 school year. Duties may include:
	<ul>
	...
	Information will be released through the school gmail shortly.`};e.content.cards=[{headerImage:{href:a,width:200},title:"Welcome to our homepage!",content:`We are the Queen's College Science Association, a club dedicated to educating students on
	...
	publication, <i>Scientia</i>, biannually. Additionally, we will also hold tons of events this year!`},{title:"Events",content:`This year, we will hold quizzes with prizes (!!!), invite ALL OF YOU to write an article about
	...
	page and this website.`},{headerImage:{href:t,width:250,source:{url:"https://commons.wikimedia.org/wiki/File:Limulus.jpg",description:"Wikipedia (Horseshoe Crab)"}},title:"FEATURE: <u>Horseshoe Crabs</u>",content:`Horseshoe crabs are truly the pinnacle of evolution. Their fossil records date back more than
	...
	hope this event can teach as all more about horseshoe crabs.`}];o(i).mount("#app");
